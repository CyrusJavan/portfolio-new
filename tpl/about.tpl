...
<div class="container">
    ...
    <div class="row justify-content-center mt-3">
        <div class="col-6 col-md-3">
            <img src="/static/img/headshot.jpg" alt="cyrus javan headshot" class="img-thumbnail">
        </div>
    </div>
    ...
    <!-- <div class="row justify-content-center mt-3">
        <div class="col-6 col-md-3">
            <img src="/static/img/bjj.jpg" alt="cyrus javan jiu jitsu" class="img-thumbnail">
        </div>
    </div>
    <div class="row justify-content-center mt-3">
        <div class="col-6 col-md-3">
            <img src="/static/img/aquarium.jpg" alt="cyrus javan aquarium" class="img-thumbnail">
        </div>
    </div> -->
</div>
{{end}}